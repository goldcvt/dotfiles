" Vim color file
" naysayyers88
" Created by disborees with ThemeCreator (https://github.com/mswift42/themecreator)
...
set t_Co=256
let g:colors_name = "naysayyers88"
    ...
    let s:func="#ffffff"
    let s:str="#2ec09c"
    let s:type="lightgreen"
    let s:var="#c8d4ec"
    let s:warning="#ffaa00"
    let s:warning2="#ffaa00"
    ...
    hi Visual guifg=black guibg=#ff8da1 gui=none
    hi Search guibg=#ff8da1 guifg=black
    "hi Search guibg=  #ffc0cb guifg=white


    " Cursor settings
    highlight Cursor guifg=black guibg=lightgreen
    highlight iCursor guifg=black guibg=lightgreen
